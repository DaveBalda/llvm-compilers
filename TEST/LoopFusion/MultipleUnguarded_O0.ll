...
13:                                               ; preds = %34, %5
  %14 = load i32, ptr %11, align 4, !dbg !14
  %15 = load i32, ptr %6, align 4, !dbg !15
  %16 = icmp slt i32 %14, %15, !dbg !16
  br i1 %16, label %17, label %37, !dbg !17

17:                                               ; preds = %13
  %18 = load ptr, ptr %8, align 8, !dbg !18
  %19 = load i32, ptr %11, align 4, !dbg !19
  %20 = sext i32 %19 to i64, !dbg !18
  %21 = getelementptr inbounds i32, ptr %18, i64 %20, !dbg !18
  %22 = load i32, ptr %21, align 4, !dbg !18
  %23 = sdiv i32 1, %22, !dbg !20
  %24 = load ptr, ptr %9, align 8, !dbg !21
  %25 = load i32, ptr %11, align 4, !dbg !22
  %26 = sext i32 %25 to i64, !dbg !21
  %27 = getelementptr inbounds i32, ptr %24, i64 %26, !dbg !21
  %28 = load i32, ptr %27, align 4, !dbg !21
  %29 = mul nsw i32 %23, %28, !dbg !23
  %30 = load ptr, ptr %7, align 8, !dbg !24
  %31 = load i32, ptr %11, align 4, !dbg !25
  %32 = sext i32 %31 to i64, !dbg !24
  %33 = getelementptr inbounds i32, ptr %30, i64 %32, !dbg !24
  store i32 %29, ptr %33, align 4, !dbg !26
  br label %34, !dbg !27

34:                                               ; preds = %17
  %35 = load i32, ptr %11, align 4, !dbg !28
  %36 = add nsw i32 %35, 1, !dbg !28
  store i32 %36, ptr %11, align 4, !dbg !28
...
38:                                               ; preds = %58, %37
  %39 = load i32, ptr %11, align 4, !dbg !33
  %40 = load i32, ptr %6, align 4, !dbg !34
  %41 = icmp slt i32 %39, %40, !dbg !35
  br i1 %41, label %42, label %61, !dbg !36

42:                                               ; preds = %38
  %43 = load ptr, ptr %7, align 8, !dbg !37
  %44 = load i32, ptr %11, align 4, !dbg !38
  %45 = sext i32 %44 to i64, !dbg !37
  %46 = getelementptr inbounds i32, ptr %43, i64 %45, !dbg !37
  %47 = load i32, ptr %46, align 4, !dbg !37
  %48 = load ptr, ptr %9, align 8, !dbg !39
  %49 = load i32, ptr %11, align 4, !dbg !40
  %50 = sext i32 %49 to i64, !dbg !39
  %51 = getelementptr inbounds i32, ptr %48, i64 %50, !dbg !39
  %52 = load i32, ptr %51, align 4, !dbg !39
  %53 = add nsw i32 %47, %52, !dbg !41
  %54 = load ptr, ptr %10, align 8, !dbg !42
  %55 = load i32, ptr %11, align 4, !dbg !43
  %56 = sext i32 %55 to i64, !dbg !42
  %57 = getelementptr inbounds i32, ptr %54, i64 %56, !dbg !42
  store i32 %53, ptr %57, align 4, !dbg !44
  br label %58, !dbg !45
...
61:                                               ; preds = %38
  store i32 25, ptr %6, align 4, !dbg !48
  store i32 0, ptr %12, align 4, !dbg !49
  br label %62, !dbg !50

62:                                               ; preds = %83, %61
  %63 = load i32, ptr %12, align 4, !dbg !51
  %64 = load i32, ptr %6, align 4, !dbg !52
  %65 = icmp slt i32 %63, %64, !dbg !53
  br i1 %65, label %66, label %86, !dbg !54

66:                                               ; preds = %62
  %67 = load ptr, ptr %8, align 8, !dbg !55
  %68 = load i32, ptr %12, align 4, !dbg !56
  %69 = sext i32 %68 to i64, !dbg !55
  %70 = getelementptr inbounds i32, ptr %67, i64 %69, !dbg !55
  %71 = load i32, ptr %70, align 4, !dbg !55
  %72 = sdiv i32 1, %71, !dbg !57
  %73 = load ptr, ptr %9, align 8, !dbg !58
  %74 = load i32, ptr %12, align 4, !dbg !59
  %75 = sext i32 %74 to i64, !dbg !58
  %76 = getelementptr inbounds i32, ptr %73, i64 %75, !dbg !58
  %77 = load i32, ptr %76, align 4, !dbg !58
  %78 = mul nsw i32 %72, %77, !dbg !60
  %79 = load ptr, ptr %7, align 8, !dbg !61
  %80 = load i32, ptr %12, align 4, !dbg !62
  %81 = sext i32 %80 to i64, !dbg !61
  %82 = getelementptr inbounds i32, ptr %79, i64 %81, !dbg !61
  store i32 %78, ptr %82, align 4, !dbg !63
  br label %83, !dbg !64

83:                                               ; preds = %66
  %84 = load i32, ptr %12, align 4, !dbg !65
  %85 = add nsw i32 %84, 1, !dbg !65
  store i32 %85, ptr %12, align 4, !dbg !65
  br label %62, !dbg !54, !llvm.loop !66

86:                                               ; preds = %62
  store i32 0, ptr %12, align 4, !dbg !67
  br label %87, !dbg !68

87:                                               ; preds = %107, %86
  %88 = load i32, ptr %12, align 4, !dbg !69
  %89 = load i32, ptr %6, align 4, !dbg !70
  %90 = icmp slt i32 %88, %89, !dbg !71
  br i1 %90, label %91, label %110, !dbg !72

91:                                               ; preds = %87
  %92 = load ptr, ptr %7, align 8, !dbg !73
  %93 = load i32, ptr %12, align 4, !dbg !74
  %94 = sext i32 %93 to i64, !dbg !73
  %95 = getelementptr inbounds i32, ptr %92, i64 %94, !dbg !73
  %96 = load i32, ptr %95, align 4, !dbg !73
  %97 = load ptr, ptr %9, align 8, !dbg !75
  %98 = load i32, ptr %12, align 4, !dbg !76
  %99 = sext i32 %98 to i64, !dbg !75
  %100 = getelementptr inbounds i32, ptr %97, i64 %99, !dbg !75
  %101 = load i32, ptr %100, align 4, !dbg !75
  %102 = add nsw i32 %96, %101, !dbg !77
  %103 = load ptr, ptr %10, align 8, !dbg !78
  %104 = load i32, ptr %12, align 4, !dbg !79
  %105 = sext i32 %104 to i64, !dbg !78
  %106 = getelementptr inbounds i32, ptr %103, i64 %105, !dbg !78
  store i32 %102, ptr %106, align 4, !dbg !80
  br label %107, !dbg !81

107:                                              ; preds = %91
  %108 = load i32, ptr %12, align 4, !dbg !82
  %109 = add nsw i32 %108, 1, !dbg !82
  store i32 %109, ptr %12, align 4, !dbg !82
...
!1 = !DIFile(filename: "MultipleUnguarded.c", directory: "/home/davebalda/workspace/LLVM17/TEST/LoopFusion")
